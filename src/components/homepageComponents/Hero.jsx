            ...
            <div className="flex justify-between items-center"> 
                <div className="hero-content w-full justify-start text-neutral-content">
                    <div className="w-96 lg:w-[500px]">
                        <h1 className="mb-5 text-5xl font-bold text-black">Trouble in <br />Task Management?</h1>
                        <p className="mb-5 text-slate-700">The Ultimate Solution for your any type of task management problems. Test By yourself...</p>
